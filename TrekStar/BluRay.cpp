...
string BluRay::get_savable() {
	return "BLURAY;" + to_string(get_id()) + ";" + get_title() + ";" + get_video_format() + ";" + get_audio_format() + ";" + get_run_time() + ";" + get_language() + ";" + get_retail_price() + ";" + get_subtitles() + ";" + get_frame_aspect() + ";" + get_packaging_material() + ";" + vector_to_string(get_additional_languages()) + ";" + vector_to_string(get_additional_subtitles()) + ";" + vector_to_string(get_bonus_features()) + ";\n";
}